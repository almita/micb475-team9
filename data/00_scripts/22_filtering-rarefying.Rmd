...
```{r}
starch_unfiltered <- readRDS("../11_phyloseq/starch_unfiltered_phyloseq.RDS")
```
...
```{r}
write_rds(starch_taxa, "../11_phyloseq/starch_filtered_phyloseq.RDS")
```
...
write_rds(starch_rare, "../11_phyloseq/starch_rarefied_phyloseq.RDS")
```
